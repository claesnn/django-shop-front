...
export interface paths {
    ...
    "/api/items-and-categories/": {
        ...
        get: operations["items_and_categories_list"];
        put?: never;
        post: operations["items_and_categories_create"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/items-and-categories/{id}/": {
        ...
        get: operations["items_and_categories_retrieve"];
        put: operations["items_and_categories_update"];
        post?: never;
        delete: operations["items_and_categories_destroy"];
        options?: never;
        head?: never;
        patch: operations["items_and_categories_partial_update"];
        trace?: never;
    };
    "/api/items/{id}/": {
        parameters: {
...
export interface operations {
    ...
    items_and_categories_list: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ItemAndCategory"][];
                };
            };
        };
    };
    items_and_categories_create: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ItemAndCategory"];
                "application/x-www-form-urlencoded": components["schemas"]["ItemAndCategory"];
                "multipart/form-data": components["schemas"]["ItemAndCategory"];
            };
        };
        responses: {
            201: {
    ...
    items_and_categories_partial_update: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["PatchedItemAndCategory"];
                "application/x-www-form-urlencoded": components["schemas"]["PatchedItemAndCategory"];
                "multipart/form-data": components["schemas"]["PatchedItemAndCategory"];
            };
        };
        responses: {
            200: {
